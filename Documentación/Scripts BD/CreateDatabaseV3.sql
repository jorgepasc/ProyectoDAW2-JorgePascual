...
CREATE TABLE Voluntarios (
  ...
  [Observaciones] varchar(400) DEFAULT NULL,
  [ProfileImagePath] varchar(max) DEFAULT NULL,
  [RutaDocumento1] varchar(max) DEFAULT NULL
...
/****** Object:  StoredProcedure [dbo].[GetVoluntariosDisponiblesForEntrenamientoByID]    Script Date: 13/04/2021 22:38:24 ******/
SET ANSI_NULLS ON
GO
